...
public class RcsBotTypeDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private RcsBotTypeDAO dataStore;

	/**
	 * Instantiates a new RcsBotTypeDAOTest.
	 *
	 */
	public RcsBotTypeDAOTest() {
	}

	/**
	* Method to test RcsBotType domain object.
	*
	*/
	@Rollback(false)
	@Test
	public void RcsBotType() {
		RcsBotType instance = new RcsBotType();
	...
	*/
	@Autowired
	public void setDataStore(RcsBotTypeDAO dataStore) {
