...
public class RcsBotDescDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private RcsBotDescDAO dataStore;

	/**
	 * Instantiates a new RcsBotDescDAOTest.
	 *
	 */
	public RcsBotDescDAOTest() {
	}

	/**
	* Method to test RcsBotDesc domain object.
	*
	*/
	@Rollback(false)
	@Test
	public void RcsBotDesc() {
		RcsBotDesc instance = new RcsBotDesc();
	...
	*/
	@Autowired
	public void setDataStore(RcsBotDescDAO dataStore) {
