...
public class RcsBotUserDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private RcsBotUserDAO dataStore;

	/**
	 * Instantiates a new RcsBotUserDAOTest.
	 *
	 */
	public RcsBotUserDAOTest() {
	}

	/**
	* Method to test RcsBotUser domain object.
	*
	*/
	@Rollback(false)
	@Test
	public void RcsBotUser() {
		RcsBotUser instance = new RcsBotUser();
	...
	*/
	@Autowired
	public void setDataStore(RcsBotUserDAO dataStore) {
