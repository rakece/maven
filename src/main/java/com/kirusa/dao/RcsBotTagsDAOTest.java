...
public class RcsBotTagsDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private RcsBotTagsDAO dataStore;

	/**
	 * Instantiates a new RcsBotTagsDAOTest.
	 *
	 */
	public RcsBotTagsDAOTest() {
	}

	/**
	* Method to test RcsBotTags domain object.
	*
	*/
	@Rollback(false)
	@Test
	public void RcsBotTags() {
		RcsBotTags instance = new RcsBotTags();
	...
	*/
	@Autowired
	public void setDataStore(RcsBotTagsDAO dataStore) {
