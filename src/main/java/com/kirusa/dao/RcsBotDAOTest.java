...
public class RcsBotDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private RcsBotDAO dataStore;

	/**
	 * Instantiates a new RcsBotDAOTest.
	 *
	 */
	public RcsBotDAOTest() {
	}

	/**
	* Method to test RcsBot domain object.
	*
	*/
	@Rollback(false)
	@Test
	public void RcsBot() {
		RcsBot instance = new RcsBot();
	...
	*/
	@Autowired
	public void setDataStore(RcsBotDAO dataStore) {
