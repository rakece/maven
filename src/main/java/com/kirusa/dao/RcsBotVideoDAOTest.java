...
public class RcsBotVideoDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private RcsBotVideoDAO dataStore;

	/**
	 * Instantiates a new RcsBotVideoDAOTest.
	 *
	 */
	public RcsBotVideoDAOTest() {
	}

	/**
	* Method to test RcsBotVideo domain object.
	*
	*/
	@Rollback(false)
	@Test
	public void RcsBotVideo() {
		RcsBotVideo instance = new RcsBotVideo();
	...
	*/
	@Autowired
	public void setDataStore(RcsBotVideoDAO dataStore) {
